...
(function () {
    ...
    URL = "/anwan/include/ueditor/"; //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'insertvideo', 'map', 'gmap', 'highlightcode', '|',
                'template','date', 'time', 'spechars', '|',
                'help']
        ]
